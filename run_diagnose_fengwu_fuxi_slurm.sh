...
#SBATCH -J diag_fw_fx
#SBATCH -o /public/home/aciwgvx1jd/new-onescience/onescience/examples/earth/graphcast/ZK_Models/logs/%j_diag_fw_fx.out
#SBATCH -e /public/home/aciwgvx1jd/new-onescience/onescience/examples/earth/graphcast/ZK_Models/logs/%j_diag_fw_fx.err
...
cd "${GRAPHCAST_ROOT}"
python ZK_Models/diagnose_fengwu_fuxi_channels.py --device dcu "$@"
