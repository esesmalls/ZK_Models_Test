...
#SBATCH -o /public/home/aciwgvx1jd/new-onescience/onescience/examples/earth/graphcast/ZK_Models/fengwu_fuxi_run/logs/%j_fw_fx_infer_plot.out
#SBATCH -e /public/home/aciwgvx1jd/new-onescience/onescience/examples/earth/graphcast/ZK_Models/fengwu_fuxi_run/logs/%j_fw_fx_infer_plot.err
...
python ZK_Models/fengwu_fuxi_run/run_fengwu_fuxi_infer_plot.py \
  --test-data "${TEST_DATA}" \
  --date "${DATE}" \
  --hour "${HOUR}" \
  --num-steps "${NUM_STEPS}" \
